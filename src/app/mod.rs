use crate::{
    markdown::{
        ...
        CodeBlockInfo, LinkOccurrence, LinkSpan,
    },
...
pub(crate) struct App {
    ...
    pub(crate) link_order: Vec<crate::markdown::LinkId>,
    pub(crate) selected_link: Option<crate::markdown::LinkId>,
    pub(crate) visual_scroll_offset: usize,
